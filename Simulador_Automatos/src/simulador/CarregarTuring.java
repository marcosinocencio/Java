...
public class CarregarTuring
{
    ...
    public CarregarTuring(String filePath)
    {
        ...
        try
        {
            ...
            nFitas = doc.getElementsByTagName("tapes").getLength();
            ...
            if( transitionNodeList.getLength() > 0 )
            {
                ...
                for( int i = 0; transitionNodeList.getLength()>i; i++ )
                {
                    ...
                    if (node.getNodeType() == Node.ELEMENT_NODE)
                    {
                        ...
                        String read = getValue(transitionElement, "read");
                        String write = getValue(transitionElement, "write");
                        String move = getValue(transitionElement, "move");
                        ...
                        if( stateList.get(fromIndex) != null && stateList.get(toIndex) != null )
                        {
                            ...
                            for( Transicao transicao : stateList.get(fromIndex).getTransicoes() )
                            {
                                if( transicao.getEstadoDestino() == stateList.get(toIndex) )
                                {
                                    ...
                                    transicao.getSimbolo().add(read+" ; "+write+" , "+move);
