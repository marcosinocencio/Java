...
import Desenho.DesenhoEstadoTuring;
 ...
 * @author Vinicius
 */
public class FramePrincipalTuring extends javax.swing.JFrame {
    private Dimension area;    
    private int x,y;
    private ArrayList<Estado> estados = new ArrayList();    
    private int n;
    public DesenhoEstadoTuring estadoSelecionado;
    public DesenhoEstadoTuring estadoInicial = null;
    public String[] fita;
     ...
     */
    public FramePrincipalTuring(TelaPrincipal tela) {
        initComponents();         
        area = new Dimension(0,0);     
        fita = new String[10000];
    }
    
    public FramePrincipalTuring(TelaPrincipal tela, JFileChooser arquivo) {
        initComponents();         
        area = new Dimension(0,0);     
        fita = new String[10000];
        abrirAutomatoCorreto(arquivo);
    }
    ...
    private void initComponents() {
        ...
        simboloComboBox1 = new javax.swing.JComboBox<>();
        ...
        editarTransicoes.getContentPane().setLayout(null);
        ...
        editarTransicoes.getContentPane().add(jLabel4);
        jLabel4.setBounds(20, 70, 127, 22);
        ...
        editarTransicoes.getContentPane().add(jButton5);
        jButton5.setBounds(80, 170, 67, 25);
        ...
        editarTransicoes.getContentPane().add(jButton6);
        jButton6.setBounds(180, 170, 73, 25);
        ...
        editarTransicoes.getContentPane().add(simboloComboBox1);
        simboloComboBox1.setBounds(180, 110, 139, 28);
        ...
        editarTransicoes.getContentPane().add(estadoDestinoComboBox1);
        estadoDestinoComboBox1.setBounds(180, 70, 139, 28);

        jLabel5.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel5.setText("Transição:");
        editarTransicoes.getContentPane().add(jLabel5);
        jLabel5.setBounds(20, 110, 90, 22);

        jLabel6.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel6.setText("Estado Selecionado:");
        editarTransicoes.getContentPane().add(jLabel6);
        jLabel6.setBounds(20, 10, 165, 22);

        estadoSelecionadoLabel1.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        editarTransicoes.getContentPane().add(estadoSelecionadoLabel1);
        estadoSelecionadoLabel1.setBounds(190, 10, 49, 22);
    ...
    private void jPanel1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel1MousePressed
        ...
        if (evt.getButton() == 1) {
            ...
            n++;
            DesenhoEstadoTuring d = new DesenhoEstadoTuring(estados.get(estados.size()-1), this);          
            d.setLocation(x, y);
            jPanel1.add(d); 
    ...
    private void passoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_passoActionPerformed
        ...
        if(estadoInicial != null){
           if(verificaTransicaoFinal()){
                ...
                if(s!= null){
                   iniciaFita(fita, s);
                   new PassoPassoTuring(estados, fita, estadoInicial.getEstado()).setVisible(true);
                }
            }
           else
                JOptionPane.showMessageDialog(this, "Há transições partindo de estados finais. Remova elas para simular a entrada", "Advertência",
    ...
    private void abrirAutomatoMetodo(){
        ...
        if (result == abrirAutomato.APPROVE_OPTION) {        
            ...
            String f = file.getPath();
                ...
                n = estados.size();
                for(Estado e : estados){
                    DesenhoEstadoTuring d = new DesenhoEstadoTuring(e,this);
    ...
    private void salvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salvarActionPerformed
        ...
        if (result == salvarAutomato.APPROVE_OPTION) {
            ...
            if (!f.endsWith(".jff"))    
                f += ".jff"; 
            sXML = new SalvarTuring(estados, f);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if(simboloComboBox1.getSelectedIndex() != -1){
            Object[] j = janelaTransicao((String)simboloComboBox1.getSelectedItem());
            if((int)j[0] == 0)
                editarTransicao( ((JTextField)j[1]).getText(), ((JTextField)j[2]).getText(), ((JComboBox)j[3]).getSelectedItem().toString());
        }
    }//GEN-LAST:event_jButton5ActionPerformed
    
    private void editarTransicao(String lido, String escrito, String direcao){
        ...
        transicao.getSimbolo().remove(simboloComboBox1.getSelectedItem().toString());
         ...
         if (lido.equals("") )   {                     
                if (escrito.equals("") ) 
                    transicao.getSimbolo().add("□ ; □ , "+direcao);
                else
                    transicao.getSimbolo().add("□ ; "+escrito+" , "+direcao);
            }
            else   {                      
                if (escrito.equals("") ) 
                    transicao.getSimbolo().add(lido+" ; □ , "+direcao);
                else
                    transicao.getSimbolo().add(lido+" ; "+escrito+" , "+direcao);   
            }
    ...
    private Object[] janelaTransicao (String transicaoSelecionada){
        ...
        campo.setText(transicaoSelecionada.substring(0, 1));
        transicao[0] = campo;   
        ...
        campo.setBorder(BorderFactory.createLineBorder(Color.black));      
        campo.setFont(new Font("Tahoma", Font.PLAIN, 15));
        campo.setText(transicaoSelecionada.substring(4, 5));
        transicao[1] = campo;   
        ...
        switch(transicaoSelecionada.substring(8, 9)){
            case "R": j.setSelectedIndex(0);
                      break;
            case "S": j.setSelectedIndex(1);
                      break;
            case "L": j.setSelectedIndex(2); 
                      break;
        }
       ...
       Object[] message = {
        ...
        message,"Editar Transição", JOptionPane.OK_CANCEL_OPTION,JOptionPane.PLAIN_MESSAGE,null);
    ...
    private boolean verificarEntrada(String entrada) {                                         
        ...
        if(verifica == 0)
            ...
            switch(transicao.substring(8, 9)){
                    case "R":   fita[i] = transicao.substring(4, 5);
                                i++;                                 
                                break;
                                
                    case "S":   fita[i] = transicao.substring(4, 5);                                   
                                break;
                                
                    case "L":   fita[i] = transicao.substring(4, 5);
                                i--;                                
                                break;
            }             
        }
    ...
    private void iniciaFita(String[] fita, String entrada){      
        ...
        for(int i = 0; i < entrada.length(); i++)
            fita[4999+i] = String.valueOf(entrada.charAt(i));
