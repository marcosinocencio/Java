...
import com.marcosinocencio.cursomc.domain.Endereco;
...
import com.marcosinocencio.cursomc.domain.PagamentoComCartao;
...
import com.marcosinocencio.cursomc.domain.enums.Perfil;
...
import com.marcosinocencio.cursomc.repositories.EnderecoRepository;
...
public class DBService {
    ...
    public void instantiateDatabase() throws ParseException {
        ...
        Cliente cli1 = new Cliente(null, "Maria Silva", "marcos_inocencio@terra.com.br", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("asdfg"));
        cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

        Cliente cli2 = new Cliente(null, "Ana Costa", "marcos.inocencio13@gmail.com", "88010183040", TipoCliente.PESSOAFISICA, pe.encode("asdfg"));
        cli2.addPerfil(Perfil.ADMIN);
        cli2.getTelefones().addAll(Arrays.asList("456436362", "456343464"));

        Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
        Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
        Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "4653466", cli2, c2);
